...
> ⚠️ **Disclaimer:** Project Hype is a **speculative research and entertainment tool only.**  
> It is **NOT financial advice** and is **NOT a recommendation to buy, sell, hold, or trade any currency or asset.**  
> Scores are generated by automated signals and may be inaccurate, incomplete, or delayed.  
> Speculative currencies carry **extreme risk** — many are subject to capital controls, sanctions, or severe illiquidity.  
> Always consult a licensed financial advisor before making any investment decision.
...
| AI Sentiment | Anthropic Claude (geopolitical signal scoring) |
...
| Source | Used for |
|---|---|
| [Open Exchange Rates](https://openexchangerates.org/) | Primary live FX feed, ~170 currencies |

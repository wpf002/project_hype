      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ borderTop: "1px solid #1e1e3f", paddingTop: 20, fontSize: 11, color: "#404060", lineHeight: 1.7 }}>
            Exchange rates: Open Exchange Rates (primary) + ExchangeRate-API (fallback), live data cached hourly. Analyst fallback rates for sanctioned/conflict currencies
            (IRR, KPW, MMK, SYP, VES, LBP, SDG, YER, SOS, ZWG). News: 2-tier RSS pipeline — IMF/World Bank/OFAC/BIS institutional feeds
            and currency-specific regional sources. Sentiment: Claude AI (Haiku). Alerts: SendGrid.
